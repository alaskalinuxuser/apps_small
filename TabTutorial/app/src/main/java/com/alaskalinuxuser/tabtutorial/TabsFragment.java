package com.alaskalinuxuser.tabtutorial;
...
public class TabsFragment extends Fragment implements OnTabChangeListener {
	...
	private final TabDefinition[] TAB_DEFINITIONS = new TabDefinition[] {
		new SimpleTabDefinition(R.id.tabA, R.layout.simple_tab, R.string.tab_title_1, R.id.tabTitle, new Fragment()),
		new SimpleTabDefinition(R.id.tabB, R.layout.simple_tab, R.string.tab_title_2, R.id.tabTitle, new Fragment()),
	};
